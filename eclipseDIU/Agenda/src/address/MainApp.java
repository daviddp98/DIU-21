...
public class MainApp extends Application {
	 ...
	 */
	private ObservableList<AgendaVO> personData = FXCollections.observableArrayList();

	/**
	 * Constructor
	 */
	public MainApp() {
		agendaM = new AgendaModelo();
	 ...
	 * @return
	 */
	public ObservableList<AgendaVO> getPersonData() {
		return personData;
	}
	...
	public void start(Stage primaryStage) {
		...
		this.primaryStage.getIcons().add(new Image("file:resources/images/iconfinder_users-groups_511933.png"));
	...
	public void initRootLayout() {
		try {
			...
			controller.setMainApp(this, agendaM);
	 ...
	 */
	public boolean showPersonEditDialog(AgendaVO person) {
		try {
			...
			alert.setHeaderText("The database is not connected.");
			alert.setContentText(
					"The connection with the database is not oppened, so is not possible to add a new person. Please, try again later.");
	...
	public void loadPersonDataFromFile(File file) {
		try {
			...
			dialogo.setHeaderText("Could not save data to file:\\n" + file.getPath());
	...
	public void setPersonData(ObservableList<AgendaVO> opl) {
		this.personData = opl;
	}
